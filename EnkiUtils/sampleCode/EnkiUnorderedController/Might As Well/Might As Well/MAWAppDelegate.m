...
#if 0
    self.navigationController = [[UINavigationController alloc] initWithRootViewController:_unorderedController];
    
    [_navigationController setNavigationBarHidden:YES animated:NO];
    [[self window] setRootViewController:_navigationController];
#endif
    [[self window] setRootViewController:_unorderedController];
